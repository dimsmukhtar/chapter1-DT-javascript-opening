...
// 1. contoh array
const contohArray = [1, "imam", 28, 2, "bagas", 30, 3, "bagus", 32]
// console.log(contohArray)

// console.log(`ini index kedua dari array arr ${contohArr[1]}`)
...
console.log(` contohBjk key name = ${contohObj.name}`)
console.log(` contohBjk key age = ${contohObj.age}`)
console.log(` contohBjk key id = ${contohObj.id}`)
